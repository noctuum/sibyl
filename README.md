...
<!-- PACKAGES:START -->
![Check Updates](https://github.com/noctuum/sibyl/actions/workflows/check-updates.yml/badge.svg) ![packages](https://img.shields.io/badge/packages-4%2F10-red)

| Package | Version | Strategy | Updated | Status |
|---------|---------|----------|---------|--------|
| [kio-s3-git](https://aur.archlinux.org/packages/kio-s3-git) | r485.29f85f4 | git-latest | 2026-09-07 | 🔄 updated to r485.29f85f4 |
...
| [marp-cli-bin](https://aur.archlinux.org/packages/marp-cli-bin) | 4.5.1 | github-release | 2026-09-06 | ❌ failed |
| [memos-bin](https://aur.archlinux.org/packages/memos-bin) | 0.30.0 | github-release | 2026-07-26 | ❌ failed |
| [miniflux-bin](https://aur.archlinux.org/packages/miniflux-bin) | 2.3.3 | github-release | 2026-07-24 | ❌ failed |
| [neovim-nightly-bin](https://aur.archlinux.org/packages/neovim-nightly-bin) | 0.13.0+dev+1536+g050fa30632 | github-nightly | 2026-09-06 | ❌ failed |
| [wireguard-gui-bin](https://aur.archlinux.org/packages/wireguard-gui-bin) | 0.1.12 | github-release | 2026-07-04 | ❌ failed |
