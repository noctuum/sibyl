...
|---------|---------|----------|---------|--------|
| [kio-s3-git](https://aur.archlinux.org/packages/kio-s3-git) | r435.255ab8f | git-latest | 2026-03-31 | ✅ up to date |
...
| [miniflux-bin](https://aur.archlinux.org/packages/miniflux-bin) | 2.2.18 | github-release | — | ❌ failed |
| [neovim-nightly-bin](https://aur.archlinux.org/packages/neovim-nightly-bin) | 0.13.0+dev+44+g8367340b05 | github-nightly | 2026-04-01 | ❌ failed |
