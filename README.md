...
<!-- PACKAGES:START -->
![Check Updates](https://github.com/noctuum/sibyl/actions/workflows/check-updates.yml/badge.svg) ![packages](https://img.shields.io/badge/packages-5%2F10-red)

| Package | Version | Strategy | Updated | Status |
|---------|---------|----------|---------|--------|
| [kio-s3-git](https://aur.archlinux.org/packages/kio-s3-git) | r492.d8fd052 | git-latest | 2026-09-09 | ✅ up to date |
...
| [neovim-nightly-bin](https://aur.archlinux.org/packages/neovim-nightly-bin) | 0.13.0+dev+1684+g0ea627cfb7 | github-nightly | 2026-09-21 | ❌ failed |
